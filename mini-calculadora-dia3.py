...
resultado_suma = primer_numero_int + segundo_numero_int

# Resta de los dos números 
resultado_resta = primer_numero_int - segundo_numero_int

# Multiplicación de los dos números
resultado_multiplicacion = primer_numero_int * segundo_numero_int

# División de los dos números
resultado_division = primer_numero_int / segundo_numero_int
